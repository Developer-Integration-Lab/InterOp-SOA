...
import net.aegis.gateway.client.connect32.util.FormatUtil;
import net.aegis.gateway.client.connect32.util.RDUtil;
...
//    private static final String PURPOSE_OF_DISCLOSURE_DISPLAY_NAME = "Healthcare Operations";
    ...
    /* (non-Javadoc)
	 * @see net.aegis.gateway.clients.connect32.rd.RetrieveDocument#retrieveDocuments(java.lang.String, java.lang.String, java.util.Map, java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see net.aegis.gateway.clients.connect32.rd.RetrieveDocument#retrieveDocuments(java.lang.String, java.lang.String, java.util.Map, java.lang.String, java.lang.String)
	 */
   ...
   /* (non-Javadoc)
 * @see net.aegis.gateway.clients.connect32.rd.RetrieveDocument#retrieveDocuments(java.lang.String, java.lang.String, java.util.Map, java.lang.String, java.util.Map, java.lang.String)
 */
    public RDEntityResponseType retrieveDocuments(String endpointURL, String localHCID, Map<String, String> remoteHCIDs, String testcaseConfig, Map<String, String> docAndRepIds, String initiatorPatientId) {
        ...
        try {
            ...
            //Dynamic proxy ************************************************************************************************
            EntityDocRetrievePortType entityDocQueryPortType32 = getServiceEndPoint(endpointURL);
            //End - Dynamic proxy ***************************************************************************
            ...
            result = entityDocQueryPortType32.respondingGatewayCrossGatewayRetrieve(respondingGatewayCrossGatewayRetrieveRequest);
    ...
    private EntityDocRetrievePortType getServiceEndPoint(String endpointURL) {
    	EntityDocRetrievePortType entityDocQueryPortType32 =null;
    	try {
    ...
    private EntityDocRetrievePortType getEntityDocQueryPortTypeFromContext() {
		return (EntityDocRetrievePortType)ApplicationContextProvider.getBean(RDUtil.ENTITY_DOC_RETRIEVE_PORT_TYPE_PROXY);
	}
}
