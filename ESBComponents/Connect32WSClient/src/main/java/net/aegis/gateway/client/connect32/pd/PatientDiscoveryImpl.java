...
public class PatientDiscoveryImpl implements PatientDiscovery {
	 ...
	 * 
	 * @see
	 * net.aegis.gateway.clients.connect32.pd.PatientDiscovery#correlatePatient
	...
	public PDEntityResponseType correlatePatient(String endpointURL, String localHCID,
		...
		try {
			...
			// Dynamic proxy
			// ************************************************************************************************
			EntityPatientDiscoveryPortType entityPatientDiscoveryPortType32 = getServiceEndPoint(endpointURL);
			// End - Dynamic proxy
			// ********************************************************************************************
			...
			result = entityPatientDiscoveryPortType32
			...
			throw new WSClient32RuntimeException("Problem occured while sending message to Gateway " , ex);
		}
	...
	private EntityPatientDiscoveryPortType getServiceEndPoint(String endpointURL) {
		EntityPatientDiscoveryPortType entityPatientDiscoveryPortType32 = null;
		try {
			entityPatientDiscoveryPortType32 = getPatientDiscovery32FromContext();

			log.debug("getServiceEndPoint() called ");

			// Use Proxy Instance as BindingProvider
			BindingProvider bp = (BindingProvider) entityPatientDiscoveryPortType32;
		...
		return entityPatientDiscoveryPortType32;
	}

	private EntityPatientDiscoveryPortType getPatientDiscovery32FromContext() {
