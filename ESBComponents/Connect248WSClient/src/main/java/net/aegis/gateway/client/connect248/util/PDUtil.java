...
public class PDUtil {
	...
	public static PatientPD unmarshallPDConfig(String fileContent) {
		...
		try {
			Class clazz = net.aegis.gateway.client.connect248.pd.ObjectFactory.class;
	...
	public static final String ENTITY_PATIENT_DISCOVERY_PORT_TYPE_PROXY = "entityPatientDiscoveryPortType248Proxy";
