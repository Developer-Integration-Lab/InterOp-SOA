...
import net.aegis.gateway.client.connect248.util.QDUtil;
...
public class QueryDocumentImpl implements QueryDocument {
    ...
    /* (non-Javadoc)
	 * @see net.aegis.gateway.clients.connect248.qd.QueryDocument#queryForDocuments(java.lang.String, java.lang.String, java.util.List, java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see net.aegis.gateway.clients.connect248.qd.QueryDocument#queryForDocuments(java.lang.String, java.lang.String, java.util.List, java.lang.String, java.lang.String)
	 */
    ...
    private EntityDocQueryPortType getServiceEndPoint(String endpointURL) {
    	EntityDocQueryPortType entityDocQueryPortType248 =null;
    	try {
