...
import net.aegis.gateway.client.connect248.qd.PatientQD;
...
public class QDUtil {
	...
	public static final String ENTITY_DOC_QUERY_PORT_TYPE_PROXY = "entityDocQueryPortType248Proxy";
	...
	public static PatientQD unmarshallQDConfig(String fileContent) {
	    ...
	    try {
	    	Class clazz = net.aegis.gateway.client.connect248.qd.ObjectFactory.class;
