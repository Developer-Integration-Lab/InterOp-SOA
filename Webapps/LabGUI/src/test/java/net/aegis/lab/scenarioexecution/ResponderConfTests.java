 ...
 */
public class ResponderConfTests extends StrutsTestCase {
    ...
    public void testScenario1005() throws Exception {
        ScenarioExecutor.executeConfScenario(1005);
    }

    public void testScenario1006() throws Exception {
        ScenarioExecutor.executeConfScenario(1006);
    }
