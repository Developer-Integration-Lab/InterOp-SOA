...
<s:form action="MessageSearch" theme="simple">
    ...
    <div id="content">
        <div class="content-title">
            <table>
                <tr>
                    <td><span class="content-title-text"><s:property value="#session.userProfile.participant.participantName" /> - Test Harness Message Search</span></td>
                ...
                <s:if test="ri2AuditLogList != null and ri2AuditLogList.size() > 0">
                    <div class="scrollable-area-200">
                        <table class="search-results">
                            ...
                            <s:iterator value="ri2AuditLogList" status="ri2Status">
                                <tr class="<s:if test="#ri2Status.odd == true">odd-row</s:if>">
                                    <td><s:date name="timestamp" format="yyyy-MM-dd HH:mm:ss" /></td>
                                    <td><s:property value="serviceSetId" /></td>
                                    <td><s:property value="status" /></td>
                                    <s:if test="service =='PD' || service == 'QD' || service == 'RD'">
                ...
                <s:if test="#attr.ri3AuditLogList != null and #attr.ri3AuditLogList.size() > 0">
                    <div class="scrollable-area-200">
                        <table class="search-results">
                            ...
                            <s:iterator value="ri3AuditLogList" status="ri3Status">
                                <tr class="<s:if test="#ri3Status.odd == true">odd-row</s:if>">
                                    <td><s:date name="timestamp" format="yyyy-MM-dd HH:mm:ss" /></td>
                                    <td><s:property value="serviceSetId" /></td>
                                    <td><s:property value="status" /></td>
                                    <s:if test="service =='PD' || service == 'QD' || service == 'RD'">
