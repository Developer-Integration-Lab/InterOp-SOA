<%--
    Document   : LogEntries
    Created on : Apr 1, 2010, 11:03:49 AM
...
<s:form action="LogEntries" theme="simple">
    ...
    <div id="content">
        <div class="content-title">
            <table>
                <tr>
                    <td><span class="content-title-text"><s:property value="#session.userProfile.participant.participantName" /> - Test Case Current Result Summary</span></td>
                    <td class="title-button">
                    	 <input type="button" class="inputButton" name="return" id="return" value="Return"
                                   onclick="returnToActiveScenarios('<s:property value="testScenario.scenarioExecutionId" />', 'ActiveScenarioResults' );" />
                        ...
                        <s:else>
                              <input type="button" class="inputButton" name="return" id="return" value="Return"
                                   onclick="returnToActiveScenarios('<s:property value="testScenario.scenarioExecutionId" />', 'ConfActiveScenarioResults' );" />
                        </s:else> --%>
        ...
        <div class="collapsible-title expanded" onclick="panelClick(this, 'collapsible-panel-4'); return false;">
            Case Result Details
        </div>
        <div class="collapsible-area" id="collapsible-panel-4">
            <span class="collapsible-content">
                <div class="content-area">
                    <table>
                        <tr>
                            ...
                            <table class="search-results">
                                ...
                                <s:iterator value="ri3DetailedAuditLogList" status="ri3DetailedAuditStatus">
                                    <tr class="<s:if test="#ri3DetailedAuditStatus.odd == true ">odd-row</s:if>">
                                        ...
                                        <td>
                                            <s:if test="extensionMessagePresent">
                                                <input type="button" class="inputButton" name="auditext2message" id="auditext3message" value="Download"
...
<script type="text/javascript">
    function returnToActiveScenarios(scenarioExecutionId, returnAction) {
        document.getElementById("LogEntries").action = "<%=request.getContextPath()%>/participant/"+returnAction;
