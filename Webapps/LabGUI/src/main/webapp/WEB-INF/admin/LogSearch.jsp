<%-- 
    Document   : LogSearch
    Created on : May 25, 2010, 00:18:45
    Author     : abhay.bakshi
--%>
...
<s:form action="LogSearch" theme="simple">
    ...
    <div id="content">
        <div class="content-title">
            <table>
                <tr>
                    <td><span class="content-title-text">Admin - Test Harness Audit Log Entry Search</span></td>
...
<script type="text/javascript">
    function downloadAuditLogMessage(pTestHarnessId, pAuditRepositoryId) {
        ...
        document.getElementById("LogSearch").action = "<%=request.getContextPath()%>/admin/LogSearch";
    }
</script>
