...
<s:form action="LogEntries" theme="simple">
    <div id="content">
            ...
            <table>
                <tr>
                    ...
                    <td class="title-button">
                        ...
                        <s:if test="submittedScenario.scenario.serviceset.labAccessFilter == @net.aegis.lab.util.LabConstants$LabType@CONFORMANCE.getId()">
                            <input type="button" class="inputButton" name="export" id="export" value="Export"
                                   title="Export Request/Response messages for the test case"
                                   onclick="ExportFiles();" />
                        </s:if>
                    </td>
                </tr>
        ...
        <div class="collapsible-title expanded" onclick="panelClick(this, 'collapsible-panel-2'); return false;">
            <s:property value="#attr.nhinvalidHeaderType"/> Execution Details
        </div>
...
<script type="text/javascript">
    function returnToSubmittedTestCases() {
        document.getElementById("LogEntries").action = '<%=request.getContextPath()%>/nhinvalid/SubmittedScenarioResults?scenarioExecutionId=<%=session.getAttribute("sessionobj.scenarioExecutionId")%>';
    ...
    function downloadResultDocument(pResultDocumentId) {
        ...
        document.getElementById("LogEntries").submit();
        document.getElementById("LogEntries").action = "<%=request.getContextPath()%>/nhinvalid/LogEntries";
    }
