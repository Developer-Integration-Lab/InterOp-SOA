...
<s:form action="MyInfo" theme="simple">
    ...
    <div id="content">
                ...
                <tr>
                    ...
                    <td class="title-button">
                        <input type="button" class="inputButton" name="save" id="save" value="Save"
                               title="Save this Nhin Rep's Contact Information"
                               onclick="saveNhinRepInfo();"/>
                    </td>
                </tr>
                <tr>
        ...
        <div class="content-area">
            ...
            <table>
                <tr>
                    <td><s:label cssClass="short" key="nhinrep.myinfo.name"/></td>
...
<script type="text/javascript">
        ...
        // of the logged in nhin rep.
        // *********************************************************************
        function saveNhinRepInfo() {
            if (false == validateForm(document.getElementById("MyInfo"))) {
                return false;
            }

            if (confirm('This action will update the contact information for this NHIN Rep. Ensure the information is correct before proceeding.')) {
