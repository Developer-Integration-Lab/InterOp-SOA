...
<head>
    ...
    <script type="text/javascript">
        ...
        function showTestCaseSpec(caseExecutionId) {
            <%--document.getElementById("TestCaseHelp").action = "<%=request.getContextPath()%>/help/TestCaseSpec";
            document.getElementById("TestCaseHelp").selectedCaseExecutionId.value = caseExecutionId;
            document.getElementById("TestCaseHelp").submit();--%>
    ...
    <s:form action="TestCaseHelp" theme="simple">
        ...
        <div id="content-no-menu">
            <div class="content-title">
                <table>
                    <tr>
                        <td><span class="content-title-text">Test Scenario:&nbsp;<s:property value="testScenario.scenario.scenarioName" /></span></td>
