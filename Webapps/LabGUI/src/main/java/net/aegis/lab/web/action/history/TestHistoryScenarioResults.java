...
public class TestHistoryScenarioResults extends BaseAction {
    ...
    public String execute() throws Exception {
        ...
        log.info("TestHistoryScenarioResults.execute() - INFO");
        log.info("TestHistoryScenarioResults.execute() - scenarioExecutionId="+scenarioExecutionId);
        ...
        try {
            ...
            if (this.getProfile() != null) {
                ...
                log.info("TestHistoryScenarioResults.execute(): role of the logged in user = " + iTheRoleOfTheLoggedInUser + " - INFO");
            }
